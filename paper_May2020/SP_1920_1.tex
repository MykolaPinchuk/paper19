% tables and figures are created on 05/(25-31) in G:\SSD_20\scripts\SP19_20
...
Postbeta & $0.64$ & $0.41$ & $0.38$ & $0.11$ & $0.06$ & $$-$0.58$ \\ 
...
Statistic & Ret & $\alpha_{CAPM}$ & $\alpha_{FF3}$ & $\alpha_{Carhart}$ & $\alpha_{FF5}$ & $\alpha_{FF5+UMD+STR}$ \\ 
\hline \\[-1.8ex] 
L/S CIV & 0.19 & 0.11 & 0.08 & 0.02 & 0.07 & 0.04 \\ 
T-stat & [ 1.44] & [ 0.82] & [ 0.64] & [ 0.17] & [ 0.51] & [ 0.25] \\ 
L/S CID & 0.26$^{*}$ & 0.29$^{**}$ & 0.17 & 0.42$^{***}$ & 0.12 & 0.34$^{**}$ \\ 
T-stat & [ 1.87] & [ 2.05] & [ 1.21] & [ 3.18] & [ 0.86] & [ 2.52] \\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table}

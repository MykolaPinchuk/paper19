...
\title{Labor Risk and the Cross-Section of Expected Returns \\ (Pinchuk 2020)}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item {Loungani, Rush and Tave (1990), Brainard and Cutler (1993): Sectoral shifts, proxied by the index of stock market dispersion, predict unemployment at the annual frequency.}
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item {Bridges the gap between macro and asset pricing literature. \\ Shows asset pricing implications of unemployment, driven by sectoral shifts.}
...
\includegraphics[width=1\textwidth]{Figure1_sl.png}
\end{frame}
...
\begin{frame}{Fama-MacBeth across decile portfolios}
\vspace{-0.4cm}
\begin{table}[!htbp] \centering 
...
\begin{frame}{Appendix: Post-ranking betas}
